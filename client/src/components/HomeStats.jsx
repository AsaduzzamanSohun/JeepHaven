...
const HomeStats = () => {
    return (
        <div className='py-20 md:py-32'>
            ...
            <div className='bg-gradient-to-r from-[#000000] to-[#130F40] text-light-blue-200 md:shadow-2xl rounded-md'>
                <div className='grid grid-cols-1 md:grid-cols-3'>
                    <div className='text-center md:border-r-2 border-b-2 border-[#130F40] py-12'>
                        <div className=''>
                            <img className='w-36 mx-auto' src={stat1} alt="" />
                        </div>
                        <h1 className='text-4xl font-extrabold text-light-blue-accent-400 mb-2'><CountUp end={13} duration={5} />+</h1>
                    ...
                    <div className='text-center md:border-r-2 border-b-2 border-[#130F40] py-12'>
                        ...
                        <h1 className='text-4xl font-extrabold text-light-blue-accent-400 mb-2'><CountUp end={14000} duration={5} />+</h1>
                    ...
                    <div className='text-center py-12'>
                        ...
                        <h1 className='text-4xl font-extrabold text-light-blue-accent-400 mb-2'><CountUp end={86000} duration={5} />+</h1>
